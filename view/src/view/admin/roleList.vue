<template>
  <div>
    ...
    <el-dialog :title="roleInfoOpTitle" :visible.sync="userInfoFormVisible" width="500px">
      <el-form :model="currentRole">
        <el-form-item label="名称" :label-width="formLabelWidth">
          <el-input v-model="currentRole.name" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="密码" :label-width="formLabelWidth">
          <el-input v-model="currentRole.password" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
    ...
    export default {
      ...
      methods:{
        ...
        initData(){
          //this.loading = true;
          var _this = this;
          var getMainDataUrl = "/system/role/list?page="+this.currentPage+"&pageSize="+this.currentPageSize;
